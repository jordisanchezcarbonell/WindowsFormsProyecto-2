...
namespace COMPLETE_FLAT_UI
{
    public partial class FormMenuPrincipal : MaterialForm
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            instalaciones.FormClosed += new FormClosedEventHandler(MostrarFormLogoAlCerrarForms);
            AbrirFormEnPanel(instalaciones);
        }
        ...
        {
            ModifPerfil frm = new ModifPerfil();
            frm.FormClosed += new FormClosedEventHandler(MostrarFormLogoAlCerrarForms);
            AbrirFormEnPanel(frm);
        }
